...
<html>
	...
	<script type="text/javascript">
		...
		function openUserInfo(){
			$D.open("userInfoWindow","用户信息",355,270,"userInfo.jsp");
		}
	</script>
	<body style="overflow: hidden">
	    ...
	    <div style="background-color:#306091;position:absolute;top:0;left:0;z-index:1;width:100%;">
	        <font style="float:left;margin-left:5px;margin-top:5px;width:200px;height:28px;" color="#ffffff" size="5"><b>WeERP财务在线</b></font>
