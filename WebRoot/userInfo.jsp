	...
	<body>
		<d:form id="infoForm" labelWidth="70">
			<d:line columnWidth="1">
				<d:field prompt="账套id" readOnly="true" name="book_set_id" editor="textfield" value="${sessionScope.book_set_id}">
				</d:field>
			</d:line>
			<d:line columnWidth="1">
				<d:field prompt="账套名称" readOnly="true" name="book_set_name" editor="textfield" value="${sessionScope.book_set_name}">
				</d:field>
			</d:line>
			<d:line columnWidth="1">
